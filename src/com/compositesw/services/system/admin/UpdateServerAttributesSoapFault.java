...
public class UpdateServerAttributesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateServerAttributesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateServerAttributesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
