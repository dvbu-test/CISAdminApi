...
public class GetTabularResultSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetTabularResultSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetTabularResultSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
