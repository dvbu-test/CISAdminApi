...
public class DestroyDomainSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public DestroyDomainSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public DestroyDomainSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
