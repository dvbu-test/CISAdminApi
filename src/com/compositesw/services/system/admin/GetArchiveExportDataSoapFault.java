...
public class GetArchiveExportDataSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetArchiveExportDataSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetArchiveExportDataSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
