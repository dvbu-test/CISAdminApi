...
public class GetArchiveImportReportSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetArchiveImportReportSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetArchiveImportReportSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
