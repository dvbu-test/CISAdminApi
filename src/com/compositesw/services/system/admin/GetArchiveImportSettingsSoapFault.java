...
public class GetArchiveImportSettingsSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetArchiveImportSettingsSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetArchiveImportSettingsSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
