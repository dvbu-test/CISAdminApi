...
public class CreateUserSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public CreateUserSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public CreateUserSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
