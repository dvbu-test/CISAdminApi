...
public class GetConnectorGroupSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetConnectorGroupSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetConnectorGroupSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
