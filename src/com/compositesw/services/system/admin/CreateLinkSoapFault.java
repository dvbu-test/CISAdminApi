...
public class CreateLinkSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public CreateLinkSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public CreateLinkSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
