...
public class CopyResourceSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public CopyResourceSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public CopyResourceSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
