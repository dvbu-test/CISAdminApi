...
public class UpdateUserSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateUserSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateUserSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
