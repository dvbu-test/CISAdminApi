...
public class ResourceExistsSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ResourceExistsSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ResourceExistsSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
