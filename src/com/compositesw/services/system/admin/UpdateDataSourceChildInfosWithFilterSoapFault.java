...
public class UpdateDataSourceChildInfosWithFilterSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateDataSourceChildInfosWithFilterSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateDataSourceChildInfosWithFilterSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
