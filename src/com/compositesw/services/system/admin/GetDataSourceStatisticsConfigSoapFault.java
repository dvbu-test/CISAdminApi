...
public class GetDataSourceStatisticsConfigSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetDataSourceStatisticsConfigSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetDataSourceStatisticsConfigSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
