...
public class GetDomainGroupsSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetDomainGroupsSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetDomainGroupsSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
