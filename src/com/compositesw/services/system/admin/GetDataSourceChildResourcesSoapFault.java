...
public class GetDataSourceChildResourcesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetDataSourceChildResourcesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetDataSourceChildResourcesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
