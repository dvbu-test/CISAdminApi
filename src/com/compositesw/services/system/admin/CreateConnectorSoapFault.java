...
public class CreateConnectorSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public CreateConnectorSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public CreateConnectorSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
