...
public class GetServerAttributesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetServerAttributesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetServerAttributesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
