...
public class UpdateConnectorSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateConnectorSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateConnectorSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
