...
public class GetParentDataSourceTypeSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetParentDataSourceTypeSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetParentDataSourceTypeSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
