...
public class UpdateResourceStatisticsConfigSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateResourceStatisticsConfigSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateResourceStatisticsConfigSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
