...
public class UpdateLinkSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateLinkSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateLinkSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
