...
public class GetLicensesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetLicensesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetLicensesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
