...
public class GetDomainsSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetDomainsSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetDomainsSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
