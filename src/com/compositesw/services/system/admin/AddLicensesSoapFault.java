...
public class AddLicensesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public AddLicensesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public AddLicensesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
