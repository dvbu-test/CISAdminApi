...
public class UpdateTriggerSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateTriggerSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateTriggerSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
