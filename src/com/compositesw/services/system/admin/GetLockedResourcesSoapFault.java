...
public class GetLockedResourcesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetLockedResourcesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetLockedResourcesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
