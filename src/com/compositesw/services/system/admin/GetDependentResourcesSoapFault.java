...
public class GetDependentResourcesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetDependentResourcesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetDependentResourcesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
