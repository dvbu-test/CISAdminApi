...
public class PerformServerActionSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public PerformServerActionSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public PerformServerActionSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
