...
public class GetCachedResourceStatisticsConfigSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetCachedResourceStatisticsConfigSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetCachedResourceStatisticsConfigSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
