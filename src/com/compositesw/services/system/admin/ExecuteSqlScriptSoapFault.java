...
public class ExecuteSqlScriptSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ExecuteSqlScriptSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ExecuteSqlScriptSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
