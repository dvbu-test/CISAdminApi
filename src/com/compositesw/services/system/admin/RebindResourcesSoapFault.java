...
public class RebindResourcesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public RebindResourcesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public RebindResourcesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
