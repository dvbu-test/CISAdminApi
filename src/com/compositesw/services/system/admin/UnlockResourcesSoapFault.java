...
public class UnlockResourcesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UnlockResourcesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UnlockResourcesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
