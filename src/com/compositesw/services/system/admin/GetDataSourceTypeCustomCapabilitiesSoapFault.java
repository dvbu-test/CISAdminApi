...
public class GetDataSourceTypeCustomCapabilitiesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetDataSourceTypeCustomCapabilitiesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetDataSourceTypeCustomCapabilitiesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
