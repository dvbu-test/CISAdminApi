...
public class GetGroupsByUserSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetGroupsByUserSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetGroupsByUserSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
