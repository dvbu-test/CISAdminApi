...
public class GetUsersSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetUsersSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetUsersSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
