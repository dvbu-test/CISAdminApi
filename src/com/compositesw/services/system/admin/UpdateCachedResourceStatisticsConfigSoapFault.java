...
public class UpdateCachedResourceStatisticsConfigSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateCachedResourceStatisticsConfigSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateCachedResourceStatisticsConfigSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
