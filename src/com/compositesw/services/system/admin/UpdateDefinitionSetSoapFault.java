...
public class UpdateDefinitionSetSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateDefinitionSetSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateDefinitionSetSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
