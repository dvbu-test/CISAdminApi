...
public class CloseResultSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public CloseResultSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public CloseResultSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
