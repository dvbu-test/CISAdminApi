...
public class GetConnectorsSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetConnectorsSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetConnectorsSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
