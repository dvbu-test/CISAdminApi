...
public class LockResourcesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public LockResourcesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public LockResourcesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
