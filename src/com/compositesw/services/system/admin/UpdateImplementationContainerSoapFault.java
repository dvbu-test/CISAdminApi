...
public class UpdateImplementationContainerSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateImplementationContainerSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateImplementationContainerSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
