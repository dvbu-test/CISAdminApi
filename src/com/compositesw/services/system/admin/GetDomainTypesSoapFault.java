...
public class GetDomainTypesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetDomainTypesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetDomainTypesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
