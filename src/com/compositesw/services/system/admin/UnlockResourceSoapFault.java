...
public class UnlockResourceSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UnlockResourceSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UnlockResourceSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
