...
public class JoinClusterSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public JoinClusterSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public JoinClusterSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
