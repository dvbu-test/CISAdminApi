...
public class ExecuteSqlSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ExecuteSqlSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ExecuteSqlSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
