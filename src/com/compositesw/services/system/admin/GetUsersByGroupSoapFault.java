...
public class GetUsersByGroupSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetUsersByGroupSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetUsersByGroupSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
