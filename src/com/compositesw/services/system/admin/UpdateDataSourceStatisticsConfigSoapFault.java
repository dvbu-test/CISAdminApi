...
public class UpdateDataSourceStatisticsConfigSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateDataSourceStatisticsConfigSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateDataSourceStatisticsConfigSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
