...
public class PerformArchiveImportSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public PerformArchiveImportSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public PerformArchiveImportSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
