...
public class UpdateBasicTransformProcedureSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateBasicTransformProcedureSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateBasicTransformProcedureSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
