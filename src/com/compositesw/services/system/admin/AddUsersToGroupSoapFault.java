...
public class AddUsersToGroupSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public AddUsersToGroupSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public AddUsersToGroupSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
