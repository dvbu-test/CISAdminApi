...
public class UpdateArchiveImportSettingsSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateArchiveImportSettingsSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateArchiveImportSettingsSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
