...
public class GetResourceStatisticsConfigSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetResourceStatisticsConfigSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetResourceStatisticsConfigSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
