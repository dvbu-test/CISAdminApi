...
public class GetExtendableDataSourceTypesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetExtendableDataSourceTypesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetExtendableDataSourceTypesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
