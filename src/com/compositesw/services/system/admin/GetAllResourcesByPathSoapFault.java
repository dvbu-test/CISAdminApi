...
public class GetAllResourcesByPathSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetAllResourcesByPathSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetAllResourcesByPathSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
