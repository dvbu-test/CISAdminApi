...
public class GetGroupsSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetGroupsSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetGroupsSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
