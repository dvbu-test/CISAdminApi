...
public class GetDataSourceTypeAttributeDefsSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetDataSourceTypeAttributeDefsSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetDataSourceTypeAttributeDefsSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
