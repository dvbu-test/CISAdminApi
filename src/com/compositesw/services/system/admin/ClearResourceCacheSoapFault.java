...
public class ClearResourceCacheSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ClearResourceCacheSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ClearResourceCacheSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
