...
public class TestDataSourceConnectionSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public TestDataSourceConnectionSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public TestDataSourceConnectionSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
