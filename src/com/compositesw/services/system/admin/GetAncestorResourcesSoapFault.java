...
public class GetAncestorResourcesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetAncestorResourcesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetAncestorResourcesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
