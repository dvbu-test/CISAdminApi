...
public class CreateDomainSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public CreateDomainSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public CreateDomainSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
