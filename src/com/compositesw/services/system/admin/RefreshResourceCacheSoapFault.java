...
public class RefreshResourceCacheSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public RefreshResourceCacheSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public RefreshResourceCacheSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
