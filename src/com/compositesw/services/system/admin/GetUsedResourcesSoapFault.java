...
public class GetUsedResourcesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetUsedResourcesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetUsedResourcesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
