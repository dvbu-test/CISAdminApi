...
public class UpdateDataSourceTypeCustomCapabilitiesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateDataSourceTypeCustomCapabilitiesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateDataSourceTypeCustomCapabilitiesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
