...
public class GetParentResourceSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetParentResourceSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetParentResourceSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
