...
public class ExecuteProcedureSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ExecuteProcedureSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ExecuteProcedureSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
