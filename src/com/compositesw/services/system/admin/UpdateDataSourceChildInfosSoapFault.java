...
public class UpdateDataSourceChildInfosSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateDataSourceChildInfosSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateDataSourceChildInfosSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
