...
public class GetDataSourceAttributeDefsSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetDataSourceAttributeDefsSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetDataSourceAttributeDefsSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
