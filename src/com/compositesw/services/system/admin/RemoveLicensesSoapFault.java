...
public class RemoveLicensesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public RemoveLicensesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public RemoveLicensesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
