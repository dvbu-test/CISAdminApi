...
public class RemoveFromClusterSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public RemoveFromClusterSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public RemoveFromClusterSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
