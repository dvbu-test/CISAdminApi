...
public class CopyResourcePrivilegesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public CopyResourcePrivilegesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public CopyResourcePrivilegesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
