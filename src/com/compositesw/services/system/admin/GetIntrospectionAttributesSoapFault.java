...
public class GetIntrospectionAttributesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetIntrospectionAttributesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetIntrospectionAttributesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
