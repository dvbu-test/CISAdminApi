...
public class UpdateResourceAnnotationSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateResourceAnnotationSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateResourceAnnotationSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
