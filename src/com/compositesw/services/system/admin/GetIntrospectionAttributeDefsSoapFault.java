...
public class GetIntrospectionAttributeDefsSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetIntrospectionAttributeDefsSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetIntrospectionAttributeDefsSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
