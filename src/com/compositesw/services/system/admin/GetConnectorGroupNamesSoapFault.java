...
public class GetConnectorGroupNamesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetConnectorGroupNamesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetConnectorGroupNamesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
