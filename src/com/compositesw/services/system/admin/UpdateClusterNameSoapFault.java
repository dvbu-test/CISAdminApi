...
public class UpdateClusterNameSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public UpdateClusterNameSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public UpdateClusterNameSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
