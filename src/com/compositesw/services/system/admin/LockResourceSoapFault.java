...
public class LockResourceSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public LockResourceSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public LockResourceSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
