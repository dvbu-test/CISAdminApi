...
public class CopyResourcesSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public CopyResourcesSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public CopyResourcesSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
