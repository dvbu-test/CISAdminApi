...
public class CreateClusterSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public CreateClusterSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public CreateClusterSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
