...
public class ParseSqlQuerySoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public ParseSqlQuerySoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public ParseSqlQuerySoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
