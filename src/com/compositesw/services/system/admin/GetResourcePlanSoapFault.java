...
public class GetResourcePlanSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetResourcePlanSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetResourcePlanSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
