...
public class GetDomainUsersSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetDomainUsersSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetDomainUsersSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
