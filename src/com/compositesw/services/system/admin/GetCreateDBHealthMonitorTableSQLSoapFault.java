...
public class GetCreateDBHealthMonitorTableSQLSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public GetCreateDBHealthMonitorTableSQLSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public GetCreateDBHealthMonitorTableSQLSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
