...
public class CreateDBHealthMonitorTableSoapFault
    extends Exception
{
     ...
     * @param faultInfo
     */
    public CreateDBHealthMonitorTableSoapFault(String message, Fault faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public CreateDBHealthMonitorTableSoapFault(String message, Fault faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
